...
```{r}
#A function to compute the grad of l(theta)
grad_nll<-function(theta1,theta2,y,a,k){
  lin_pred     <- theta1+theta2*a
  mu           <- k*exp(lin_pred)
...
#A function to compute the hess of l(theta)
hess_nll<-function(theta1,theta2,y,a,k){
  lin_pred     <- theta1+theta2*a
  mu           <- k*exp(lin_pred)
