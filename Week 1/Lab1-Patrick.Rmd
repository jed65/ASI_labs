...
```{r }
cat(exp(output[3]),':',1,'Ratio of death between men and women','\n')
cat(exp(output[2]),'Increase in rate of death for each year older','\n')
cat(log(2)/output[2],'number of years for the mortality rate to double','\n')
