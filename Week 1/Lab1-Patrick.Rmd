...
```{r}
fitted<-lm(log(rate)~age,data=dat[1:17,]) # Fit linear model to male data
fitted$coefficients # Get the values of the intercept/slope
=======
par(mfrow=c(1,2))
...
fitted$coefficients
>>>>>>> 1a74b8092115bf0608a820da21fcdec71dffd131
```
